...
namespace PetaPoco
{
    ...
    public class RelationshipsToFill2Attribute : Attribute
    {
        /// <summary>
        ...
        /// <summary>
        ///     Constructs a new instance of the <seealso cref="RelationshipsToFill2Attribute" />.
        /// </summary>
        ...
        public RelationshipsToFill2Attribute(Type _class, SQLJoinsTypes join, string[] relationshipsColumns)
        {
            this.Class = _class;
            this.Join = join;
