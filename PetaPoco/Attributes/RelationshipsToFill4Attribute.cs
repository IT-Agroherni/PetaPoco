...
namespace PetaPoco
{
    ...
    public class RelationshipsToFill4Attribute : Attribute
    {
        /// <summary>
        ...
        /// <summary>
        ///     Constructs a new instance of the <seealso cref="RelationshipsToFill4Attribute" />.
        /// </summary>
        ...
        public RelationshipsToFill4Attribute(Type _class, SQLJoinsTypes join, string[] relationshipsColumns)
        {
            this.Class = _class;
            this.Join = join;
