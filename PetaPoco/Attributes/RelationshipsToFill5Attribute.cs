...
namespace PetaPoco
{
    ...
    public class RelationshipsToFill5Attribute : Attribute
    {
        /// <summary>
        ...
        /// <summary>
        ///     Constructs a new instance of the <seealso cref="RelationshipsToFill5Attribute" />.
        /// </summary>
        ...
        public RelationshipsToFill5Attribute(Type _class, SQLJoinsTypes join, string[] relationshipsColumns)
        {
            this.Class = _class;
            this.Join = join;
