...
namespace PetaPoco
{
    ...
    public class RelationshipsToFill3Attribute : Attribute
    {
        /// <summary>
        ...
        /// <summary>
        ///     Constructs a new instance of the <seealso cref="RelationshipsToFill3Attribute" />.
        /// </summary>
        /// <param name="_class">Type of our class we are going to relationship.</param>        
        /// <param name="join">Type of our JOIN we are going to relationship.</param>        
        /// <param name="relationshipsColumns">Type of our columns we are going to relationship.</param>        
        public RelationshipsToFill3Attribute(Type _class, SQLJoinsTypes join, string[] relationshipsColumns)
        {
            this.Class = _class;
            this.Join = join;
