...
namespace PetaPoco
{
    ...
    public class RelationshipsToFill8Attribute : Attribute
    {
        /// <summary>
        ...
        /// <summary>
        ///     Constructs a new instance of the <seealso cref="RelationshipsToFill8Attribute" />.
        /// </summary>
        ...
        public RelationshipsToFill8Attribute(Type _class, SQLJoinsTypes join, string[] relationshipsColumns)
        {
            this.Class = _class;
            this.Join = join;
