...
namespace PetaPoco
{
    ...
    public class RelationshipsToFill7Attribute : Attribute
    {
        /// <summary>
        ...
        /// <summary>
        ///     Constructs a new instance of the <seealso cref="RelationshipsToFill7Attribute" />.
        /// </summary>
        ...
        public RelationshipsToFill7Attribute(Type _class, SQLJoinsTypes join, string[] relationshipsColumns)
        {
            this.Class = _class;
            this.Join = join;
